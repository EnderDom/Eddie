/* $Id: IPRScanClient.java 2087 2012-04-03 15:06:30Z uludag $
 * ======================================================================
 * JDispatcher InterProScan (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.iprscan.*;

/**
 * <p>
 * JDispatcher InterProScan (SOAP) web service Java client using Apache Axis
 * 1.x.
 * </p>
 * 
 * <p>
 ...
 * <ul>
 * <li><a
 * href="http://www.ebi.ac.uk/Tools/webservices/services/sss/iprscan_soap"
 * >http://www.ebi.ac.uk/Tools/webservices/services/sss/iprscan_soap</a></li>
 * <li><a
...
public class IPRScanClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private String revision = "$Revision: 2087 $";
	...
	public InputParameters loadParams(CommandLine line) throws IOException {
		...
		if (line.hasOption("crc"))
			params.setNocrc(new Boolean(false));
		else if (line.hasOption("nocrc"))
			params.setNocrc(new Boolean(true));
	 ...
	 * to work
	 */
	public void submitJobFromCli(CommandLine cli, String inputSeq, int num)
		...
		if (cli.hasOption("async")) {
			...
			String[] resultFilenames = this
					.getResults(jobid, cli.getOptionValue("outfile")+num, cli
