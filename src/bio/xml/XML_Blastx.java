...
public class XML_Blastx{
	...
	private void parse2Cache(boolean dropDOM){
		...
		try {
			...
			logger.error("Failed to get BlastOutput iterations..?",e);
		}
		if(elementList != null){
	...
	/**
	 * Changes the value of an item in the original document
	 * this will not have any effect on the cache
	 * @param tag the XML tag to be changed
	 * @param value value to change to
	 * @param all change all values with tag or just the first
	 * 
	 * @deprecated
	 */
