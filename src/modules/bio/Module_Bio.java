...
public class Module_Bio extends Module_Basic{
	...
	//Change to Options ...?
	protected String[] tasks = new String[]{"blast", "webblast", "blast2sql","converter","seqanalysis", "assemblytools", "fastatools", 
			"iprscanweb", "chimera", "blastanalysis"}; 
	protected String[] taskinfo = new String[]{"	run a blast program", "run web blast", 
			"Upload blast results to mysql db", "converts bio Files", "Analysis of Sequence files", "Assembly Tools", "Fasta Tools",
	...
	protected String[] classes = new String[]{Task_BlastLocal.class.getName(),Task_BlastLocal.class.getName(),
			Task_BlastLocal.class.getName(),Task_Convert.class.getName(),Task_Sequence_Analysis.class.getName(), Task_Assembly.class.getName(),
