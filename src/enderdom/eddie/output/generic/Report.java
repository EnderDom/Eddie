package enderdom.eddie.output.generic;
...
public class Report {
	...
	private String defaultHeader = "<head><title>Generic HTML Document Automatically Generated By Eddie"+EddiePropertyLoader.getFullVersion()+"</title></head>";
