...
public abstract class GenericGUI extends JFrame implements ActionListener, WindowListener, UI, FileReciever{
	...
	public GenericGUI(PropertyLoader loader, String programname){
		super(programname+" v"+loader.getValue("FULLVERSION") + " " + loader.getValue("EDITION") + " Edition");
		this.load = loader;
		this.programname = programname;
		System.out.println(programname+" v" + loader.getValue("FULLVERSION") + " by (S.C.Corp.)");
	...
	public UserResponse requiresUserYNI(String message, String title) {
		int r = JOptionPane.showInternalConfirmDialog(this.desktop, message, title, JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE);
		switch(r){ 
			case JOptionPane.NO_OPTION : return UserResponse.NO;
			case JOptionPane.YES_OPTION : return UserResponse.YES;
			default : return UserResponse.CANCEL;
		}
	}
	...
	public TaskManager getTaskManager(){
		if(manager == null)this.buildTaskManager();
		return this.manager;
	}
}
